function FilterableCategory(props) {
  const { toggleCategoryForm, handSetCatagory, catagories } = props;
  return (
    <div>
      <div className="relative h-96 rounded overflow-hidden flex flex-col items-center">
        {" "}
        {/*  */}
        <svg
